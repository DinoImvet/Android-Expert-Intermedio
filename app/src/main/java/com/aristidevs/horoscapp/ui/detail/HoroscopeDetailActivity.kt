...
///////////////////////////3.- LUEGO AQUI AGARRAMOS EL horoscopeDetailViewModel QUE CONTIENE LA CLASE DEL ESTADO HoroscopeDetailState

    private lateinit var binding: ActivityHoroscopeDetailBinding

    //private val horoscopeDetailViewModel: HoroscopeDetailViewModel by viewModels() es igual a si ponemos
    ...
    private fun initUIState() {
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED) {
                horoscopeDetailViewModel.horoscopeState.collect {
                    when (it) {
